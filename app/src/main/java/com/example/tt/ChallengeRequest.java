...
public class ChallengeRequest extends JsonObjectRequest {
    final static private String URL = "http://52.79.125.108/api/challenge/";
    private HashMap<String, String> params;

    public ChallengeRequest(int method, String url, JSONObject jsonRequest, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener){
